...
#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://Happy:1234567890as@cluster1.lxk89.mongodb.net/?retryWrites=true&w=majority&appName=Cluster1")
...
VERIFY_EXPIRE = int(os.environ.get('VERIFY_EXPIRE', 800)) # Add time in seconds
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "1473392446").split()):
        ADMINS.append(int(x))
except ValueError:
